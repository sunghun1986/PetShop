...
<script>
	...
	function edit(product_id, id) {
		...
		if (confirm(product_id + " 상품의 갯수를" + ea + " 개로 수정할래요?")) {
			location.href = "/shop/cart/edit?product_id=" + product_id + "&ea="
					+ ea;
		}
	}
	...
	<div id="body">
		<div id="content">
			...
			<form action="/action_page.php">
				<div id="buyer">
					<input type="text" id="fname" name="firstname" placeholder="주문자 이름"> 
					<input type="text" id="lname"	name="lastname" placeholder="주문자 연락처">
					<input type="text" id="lname"	name="lastname" placeholder="주문자 이메일"> 
